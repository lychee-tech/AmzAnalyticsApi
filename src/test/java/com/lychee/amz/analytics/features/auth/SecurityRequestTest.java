...
public class SecurityRequestTest {
    ...
    public void requestCreateAccountNoNeedAuth(){
        ...
        ResponseEntity<UserDTO> response = restTemplate.postForEntity("http://localhost:8080/accounts",request, UserDTO.class);
    ...
    public void requestUpdateAccountNeedAuth(){
        ...
        ResponseEntity<UserDTO> response1 = restTemplate.postForEntity("http://localhost:8080/accounts",request1,UserDTO.class);
        ...
        ResponseEntity<UserDTO> response = restTemplate.exchange("http://localhost:8080/accounts/1", HttpMethod.PUT,entity,UserDTO.class);
        assertEquals(response.getStatusCode().toString(),"200");
    }
